...
namespace DotNetTest.DAL.DesignPattern
{
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        private readonly IUnitOfWork<AppContext> _uow;
        ...
        public Repository(IUnitOfWork<AppContext> unitOfWork, IHttpContextAccessor httpContext, IConfiguration configuration)
        {
